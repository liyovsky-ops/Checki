...
def test_fetch_user():
    ...
    rywale: [
      ...
      },
      {
        ...
        icon: '🎲',
        color: '#e91e63',
        tagline: 'Property-based testing',
        pros: ['Generuje losowe dane testowe', 'Znajduje edge casy które pominąłeś', 'Minimalizuje failing przykład', 'Integruje się z pytest'],
        cons: ['Inny model myślenia', 'Wolniejszy', 'Nie zastępuje klasycznych testów', 'Krzywa uczenia'],
        vsReact: 'Hypothesis i pytest się uzupełniają — nie konkurują. Hypothesis generuje dane wejściowe, pytest uruchamia testy. Razem = potężna kombinacja.',
        bestFor: 'Testowanie parsowania, walidacji, algorytmów — gdzie edge casy są trudne do przewidzenia'
      },
      {
        name: 'doctest',
        icon: '📖',
